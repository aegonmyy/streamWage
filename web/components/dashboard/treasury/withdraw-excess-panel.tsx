    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Withdraws only what clears the 1-hour reserve floor.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-2">
            ...
            {ethAmount > safeWithdrawableAmount && (
              <p className="text-xs text-red-500 font-medium">
                Exceeds safe amount ({formatEth(safeWithdrawableAmount, 4)} ETH)
              </p>
            )}
          </div>
          ...
          <Button
            ...
            className="w-full"
          >
            {isWithdrawPending || isConfirming ? "Withdrawing..." : "Withdraw"}
          </Button>
        </CardContent>
      </Card>
